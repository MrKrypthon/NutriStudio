...
Última verificación contra código real (no contra specs): 1 de septiembre de 2026 (madrugada, fase 15).
...
(Negrita = construido en esta sesión: fase 3 a 12, 14 y 15 en esta rama — fase 13 (Biblioteca de educación) vive en la rama `biblioteca-educacion` con su propio PR — más los bugfixes de Recetas, control de acceso y CORS.)
