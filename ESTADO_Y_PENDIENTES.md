...
(Negrita = construido en esta sesión: fase 3 a 13, y los bugfixes de Recetas, control de acceso y CORS. Fase 11, 12 y 13 se ramificaron todas desde `main` en puntos distintos y se fueron mergeando por separado — este documento refleja el estado ya fusionado.)
